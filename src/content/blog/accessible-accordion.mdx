...
## How & Why? 
 ...
 <Accordion>
        <AccordionSection title="Signalling functionality for keyboard users #1">
          <h4>Feature:</h4>
  ...
  <AccordionSection title="Signalling functionality for keyboard users #2">
          <h4>Feature:</h4>
          <p>
        ...
        <AccordionSection title="Signalling functionality to sighted users #1">
          <h4>Feature:</h4>
          <p>
        ...
        <AccordionSection title="Signalling functionality to sighted users #2">
          <h4>Feature:</h4>
