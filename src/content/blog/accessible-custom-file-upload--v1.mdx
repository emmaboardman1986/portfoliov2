...
> Disclaimer: The internet is full of articles on accessible, custom-styled file upload buttons. This post does not attempt to reinvent the wheel. It is my personal exploration of what is required to make the key components of the web inclusive and accessible.

<BodyText>
So as to not overload the content per post, this post will focus on Version 1, as described by the image below:
</BodyText>  
...
<BodyText>
  {" "}
  A follow-up blog-post will focus on expanding this initial semantic mark-up into a more integrated JavaScript solution, shown as Version 2 below:
</BodyText>  
